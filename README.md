...
- `pnpm run dev` - Start Vite + Convex dev servers concurrently
- `pnpm run dev:web` - Start only the Vite dev server
- `pnpm run dev:convex` - Start only the Convex dev server
